...
void ui_BrewScreen_screen_init(void)
{
    ...
    lv_obj_set_y(ui_BrewScreen_ImgButton5, 70);
    ...
    lv_obj_set_width(ui_BrewScreen_contentPanel4, lv_pct(100));
    lv_obj_set_height(ui_BrewScreen_contentPanel4, lv_pct(100));
    ...
    lv_obj_set_x(ui_BrewScreen_startButton, 200);
    lv_obj_set_y(ui_BrewScreen_startButton, 0);
    ...
    lv_obj_set_width(ui_BrewScreen_controlContainer, 640);
    lv_obj_set_height(ui_BrewScreen_controlContainer, 180);
    lv_obj_set_align(ui_BrewScreen_controlContainer, LV_ALIGN_CENTER);
    lv_obj_set_flex_flow(ui_BrewScreen_controlContainer, LV_FLEX_FLOW_COLUMN_WRAP);
    ...
    lv_obj_set_y(ui_BrewScreen_profileInfo, 61);
    ...
    lv_obj_add_flag(ui_BrewScreen_Label1, LV_OBJ_FLAG_HIDDEN);     /// Flags
    ...
    lv_obj_set_width(ui_BrewScreen_Container3, 350);
    ...
    lv_obj_set_y(ui_BrewScreen_saveButton, -35);
    lv_obj_set_align(ui_BrewScreen_saveButton, LV_ALIGN_LEFT_MID);
    ...
    lv_obj_set_align(ui_BrewScreen_acceptButton, LV_ALIGN_LEFT_MID);
    lv_obj_add_flag(ui_BrewScreen_acceptButton, LV_OBJ_FLAG_HIDDEN);     /// Flags
    ui_object_set_themeable_style_property(ui_BrewScreen_acceptButton, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR, _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_BrewScreen_acceptButton, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
    ...
    lv_obj_set_x(ui_BrewScreen_saveAsNewButton, 0);
    lv_obj_set_y(ui_BrewScreen_saveAsNewButton, 35);
    lv_obj_set_align(ui_BrewScreen_saveAsNewButton, LV_ALIGN_LEFT_MID);
