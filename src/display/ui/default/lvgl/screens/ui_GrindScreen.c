...
void ui_GrindScreen_screen_init(void)
{
    ...
    lv_obj_set_y(ui_GrindScreen_ImgButton2, 70);
    ...
    ui_object_set_themeable_style_property(ui_GrindScreen_ImgButton2, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);

    ui_GrindScreen_contentPanel7 = lv_obj_create(ui_GrindScreen);
    lv_obj_set_width(ui_GrindScreen_contentPanel7, lv_pct(100));
    lv_obj_set_height(ui_GrindScreen_contentPanel7, lv_pct(100));
    ...
    lv_obj_set_y(ui_GrindScreen_mainLabel7, -70);
    ...
    lv_obj_set_x(ui_GrindScreen_startButton, 200);
    lv_obj_set_y(ui_GrindScreen_startButton, 0);
    ...
    lv_obj_set_x(ui_GrindScreen_modeSwitch, -20);
    lv_obj_set_y(ui_GrindScreen_modeSwitch, 0);
    ...
    lv_obj_set_flex_align(ui_GrindScreen_modeSwitch, LV_FLEX_ALIGN_SPACE_AROUND, LV_FLEX_ALIGN_CENTER,
