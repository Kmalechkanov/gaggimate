...
void ui_MenuScreen_screen_init(void)
{
    ...
    lv_obj_set_y(ui_MenuScreen_standbyButton, 70);
    ...
    lv_obj_set_width(ui_MenuScreen_contentPanel1, lv_pct(100));
    lv_obj_set_height(ui_MenuScreen_contentPanel1, lv_pct(100));
