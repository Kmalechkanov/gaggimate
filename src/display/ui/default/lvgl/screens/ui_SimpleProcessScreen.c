...
void ui_SimpleProcessScreen_screen_init(void)
{
    ...
    lv_obj_set_y(ui_SimpleProcessScreen_ImgButton6, 70);
    ...
    lv_obj_set_width(ui_SimpleProcessScreen_contentPanel5, lv_pct(100));
    lv_obj_set_height(ui_SimpleProcessScreen_contentPanel5, lv_pct(100));
    ...
    lv_obj_set_y(ui_SimpleProcessScreen_mainLabel5, -70);
    ...
    lv_obj_set_x(ui_SimpleProcessScreen_goButton, 200);
    lv_obj_set_y(ui_SimpleProcessScreen_goButton, 0);
    ...
    lv_obj_set_x(ui_SimpleProcessScreen_Image9, -200);
    lv_obj_set_y(ui_SimpleProcessScreen_Image9, 0);
