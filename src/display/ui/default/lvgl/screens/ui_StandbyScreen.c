...
void ui_StandbyScreen_screen_init(void)
{
    ...
    lv_obj_add_event_cb(ui_StandbyScreen, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED,
    ...
    lv_obj_set_y(ui_StandbyScreen_time, -45);
    ...
    lv_obj_set_y(ui_StandbyScreen_Container1, -75);
    ...
    lv_obj_set_y(ui_StandbyScreen_Image3, 60);
