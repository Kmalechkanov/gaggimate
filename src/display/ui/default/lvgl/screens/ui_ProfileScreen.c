...
void ui_ProfileScreen_screen_init(void)
{
    ...
    lv_obj_add_event_cb(ui_ProfileScreen, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED,
                        ui_ProfileScreen_screen_destroy);
    ...
    lv_obj_set_y(ui_ProfileScreen_ImgButton1, 70);
    lv_obj_set_align(ui_ProfileScreen_ImgButton1, LV_ALIGN_CENTER);
    ui_object_set_themeable_style_property(ui_ProfileScreen_ImgButton1, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    lv_obj_set_width(ui_ProfileScreen_contentPanel, lv_pct(100));
    lv_obj_set_height(ui_ProfileScreen_contentPanel, lv_pct(100));
    ...
    lv_obj_set_width(ui_ProfileScreen_profileDetails, 640);
    lv_obj_set_height(ui_ProfileScreen_profileDetails, 180);
    ...
    lv_obj_set_x(ui_ProfileScreen_chooseButton, 60);
    lv_obj_set_y(ui_ProfileScreen_chooseButton, 70);
    ...
    lv_obj_set_height(ui_ProfileScreen_simpleContent, 80);
    lv_obj_set_x(ui_ProfileScreen_simpleContent, 0);
    lv_obj_set_y(ui_ProfileScreen_simpleContent, 10);
    ...
    lv_obj_set_height(ui_ProfileScreen_extendedContent, 100);
    ...
    lv_obj_set_y(ui_ProfileScreen_mainLabel, -70);
    ...
    lv_obj_set_y(ui_ProfileScreen_profileName, -40);
    ...
    lv_obj_set_x(ui_ProfileScreen_tempIcon, -200);
    lv_obj_set_y(ui_ProfileScreen_tempIcon, -40);
    ...
    lv_obj_set_x(ui_ProfileScreen_targetIcon, 200);
    lv_obj_set_y(ui_ProfileScreen_targetIcon, -40);
    ...
    lv_obj_set_x(ui_ProfileScreen_targetTemp2, -160);
    lv_obj_set_y(ui_ProfileScreen_targetTemp2, -40);
    ...
    lv_obj_set_x(ui_ProfileScreen_targetDuration2, 160);
    lv_obj_set_y(ui_ProfileScreen_targetDuration2, -40);
